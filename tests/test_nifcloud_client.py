...
class TestNifCloudClientRequest(unittest.TestCase):
    def test_request_method_get_computing_describe_regions(self):
    ...
    def test_request_method_post_computing_describe_regions(self):
        sut = ComputingClient(region_name="jp-east-1")
        params = {
            'Action': 'DescribeRegions',
        }
    ...
    def test_post_computing_describe_regions(self):
        ...
        response = sut.post(query=params)
        self.assertEqual(response.status_code, 200)
